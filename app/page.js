  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
            ...
            <p className="text-lg text-gray-700 mb-6">A platform for writing and sharing your thoughts.</p>
            <button className="bg-blue-500 text-white rounded p-2 hover:bg-blue-600 transition-colors">
                <a href="/addTopic/123">Add Topic</a>

            </button>
            <button className="bg-blue-500 text-white rounded p-1 px-4 hover:bg-blue-600 transition-colors mt-3 ">
                <a href="/allNotes"> allNotes </a>
            </button>
        </div>
      </div>
      );
